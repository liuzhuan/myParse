...
Page({
	...
	<div style="margin-top:10px;">
		...
		<blockquote>myParse支持70%的html的标签</blockquote>
		<div style="margin-top:10px;">
			<span>span标签</span>
	...
	<div style="margin-top:10px;">
		...
		<blockquote>myParse可以渲染原html带有的style样式</blockquote>
		<div style="margin-top:10px;">
			<span>span标签</span>
	...
	<div style="margin-top:10px;">
		...
		<blockquote>myParse可以注入html带有的class属性</blockquote>
	</div>

	<div style="margin-top:10px;">
		<h3 style="color: #000;">支持emojis小表情</h3>
		<blockquote>myParse可以解析固定格式的小表情标签</blockquote>
		<div style="margin-top:10px;">
	...
	<div style="margin-top:10px;">
		...
		<blockquote>myParse可以动态计算图片大小并进行自适应适配</blockquote>
		<div style="margin-top:10px;">
	...
	<div style="margin-top:10px;">
		...
		<blockquote>myParse可以讲一篇文章中的几个图片一起预览</blockquote>
		<div style="margin-top:10px;">
	...
	<div style="margin-top:10px;">
		...
		<blockquote>myParse支持特定设置下的多数据渲染，适用于在评论、多文本分别渲染等</blockquote>
	...
	<div style="margin-top:10px;">
		...
		<blockquote>myParse目前对于table的支持比较有限</blockquote>
		<div style="margin-top:10px; text-align:center;">
			<table>
	  <tr>
			<th>标题1</th>
